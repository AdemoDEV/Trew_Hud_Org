...
Citizen.CreateThread(function()
	...
	while ESX.GetPlayerData().org == nil do --Double Job /setorg Debug By Ademo 
...
AddEventHandler('trew_hud_ui:setInfo', function(info)
	...
	SendNUIMessage({ action = 'setText', id = 'org', value = info['org'] }) --Double Job /setorg Debug By Ademo 
	...
	if ESX.PlayerData.org ~= nil then --Double Job /setorg Debug By Ademo 
 
		if ESX.PlayerData.org.gradeorg_name ~= nil and ESX.PlayerData.org.gradeorg_name == 'boss' then --Double Job /setorg Debug By Ademo 
			...
			end, ESX.PlayerData.org.name) --Double Job /setorg Debug By Ademo 
...
RegisterCommand('toggleui', function()
	...
	if not toggleui then
		...
		SendNUIMessage({ action = 'element', task = 'disable', value = 'org' }) --Double Job /setorg Debug By Ademo 
		...
		if (Config.ui.showorg == true) then

			SendNUIMessage({ action = 'element', task = 'enable', value = 'org' }) --Double Job /setorg Debug By Ademo 
